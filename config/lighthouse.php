...
// app('log')->info('Lighthouse config loaded', ['mutations' => config('lighthouse.mutations')]);
...
return [
  ...
  'schema' => [
    ...
    'queries' => [
        'me'    => App\GraphQL\Queries\AuthQuery::class . '@me',
        'tasks' => App\GraphQL\Queries\TaskQuery::class . '@tasks',
